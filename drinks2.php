			...
			<div class="product-grid__wrapper">
				...
				<div class="product-grid__product-wrapper" id="p">
					<div class="product-grid__product">
						...
						<div class="product-grid__extend-wrapper">
							<div class="product-grid__extend">
								<span class="product-grid__btn product-grid__add-to-cart"><i class="fa fa-cart-arrow-down"></i><?php include("pay6.php") ?></span>
				...
				<div class="product-grid__product-wrapper" id="p">
					<div class="product-grid__product">
						...
						<div class="product-grid__extend-wrapper">
							<div class="product-grid__extend">
								<span class="product-grid__btn product-grid__add-to-cart"><i class="fa fa-cart-arrow-down"></i><?php include("pay7.php") ?></span>
...
<div class="product-grid__product-wrapper">
					<div class="product-grid__product" id="p">
						...
						<div class="product-grid__extend-wrapper">
							<div class="product-grid__extend">
								<span class="product-grid__btn product-grid__add-to-cart"><i class="fa fa-cart-arrow-down"></i><?php include("pay8.php") ?></span>
